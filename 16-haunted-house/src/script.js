...
// y is the wall height + half of the cone height -> 2.5 + 1 / 2
...
const door = new THREE.Mesh(
  ...
  new THREE.MeshStandardMaterial({
    ...
    // need to have transparent - true to enable alphaMap
    transparent: true,
    alphaMap: doorAlphaTexture,
    aoMap: doorAmbientOcclusionTexture,
    // we need to add some more vertices otherwise its not going to work
...
// need to add 0.001 to prevent z fighting
...
// since its near the house, we will just need to add into the house group
